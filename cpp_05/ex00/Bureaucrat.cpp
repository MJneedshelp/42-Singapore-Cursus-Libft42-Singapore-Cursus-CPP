...
/*   Updated: 2025/07/10 01:51:05 by mintan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Bureaucrat::Bureaucrat(int grade): _name(BUREAU_NAME), _grade(grade)
{
	_checkGrade(grade);
	return;
}

Bureaucrat::Bureaucrat(Bureaucrat const &src): _name(BUREAU_NAME)
{
	*this = src;
